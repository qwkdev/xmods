(async () => {
		...
		global: [{
			...
			run: function() {
				this.enabled ? (this.enabled = !1, clearInterval(this.data), this.data = null) : (this.enabled = !0, this.data = setInterval(() => {
					...
					try {
						"typing" != r.qType ? (
							"feedback" === t || a ? document.querySelector('[class*="feedback"]')?.firstChild : [...document.querySelectorAll('[class*="answerContainer"]')][r.answers.map((e, t) => r.correctAnswers.includes(e) ? t : null).filter(e => null != e)[0]]
						)?.click?.() : Object.values(document.querySelector("[class*='typingAnswerWrapper']"))[1].children._owner.stateNode.sendAnswer(r.answers[0])
					} catch {}
				}, 50))
			}
		}, {
	...
	w("Alerts", "https://res.cloudinary.com/dhiws7ac5/image/upload/v1743434255/alerts_dsucpi.png", C.alerts, !0),
		...
		w("Credits", "https://res.cloudinary.com/dhiws7ac5/image/upload/v1743434343/credits_l5dseb.webp", C.credits, !0),
		S(m, _),
		S(g, _),
