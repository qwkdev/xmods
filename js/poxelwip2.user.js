...
function parseData(data) {
	...
	if (compareByIndex(b,
		...
		console.log('%c[;] Hooking current players...', 'font-size: 20px; color: red;');
  // console.log('[;]', b);


//       try {
//         const decoded = CBOR.decode(b);

//         console.log('[;]', decoded);
//       } catch (e) {
//         console.log('[;] Not one CBOR object:', e.message);

//           try {
//             CBOR.decodeMultiple(b, value => {
//               console.log('[;]', value);
//             });
//           } catch (e2) {
//             console.error('[;] CBOR parsing failed:', e2);
//           }
//       }
		...
		for (const part of parts) {
			...
			console.log(`%c[;] Hooked ${pnum}: ${part[1]} (${part[0]}`, 'font-size: 15px; color: green;');
		}
	}
	...
	if (compareByIndex(b,
		...
		console.log('%c[;] Hooking new player...', 'font-size: 20px; color: red;');
		...
		console.log(`%c[;] Hooked ${username}`, 'font-size: 15px; color: green;');
	} else if (compareByIndex(b,
		[0, 1, 2, 3],
		[15, 255, 1, 64]
	)) {
		console.log('%c[;] Unhooking player...', 'font-size: 20px; color: red;');
...
window.WebSocket = function(...args) {
    ...
    ws.addEventListener('open', () => {
        gameSocket = ws;
        console.log('%c[;] Hooked', 'font-size: 30px; color: red;');
    });
